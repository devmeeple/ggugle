...
완벽주의, 강박관념에 사로 잡히는 시간이 길었다. 강의를 통해 마음에 짐을 조금 덜었다. 강의를 통해 갈증을 해소한다.
...
> 구조에 집착하지 않되 나만의 구조는 중요하다.

- **목차는 글의 구성을 표현하는 방법이다.**
- **'서론 본론 결론' 또는 나만의 템플릿 구성하기**
  - 좋은 글 분석하기: 내가 표현하고 싶은 이야기를 잘 전달하는 방법을 선택하기
- **꿀팁: 매크로 등록**
  - Espanso, Raycast, 스트림 덱
- **작게 시작하기**
  - 각 부분에서 전달하고 싶은 이야기를 1줄로 작성하고 살 붙이기
  - 순서대로 작성할 필요 없다. 전략적으로 선택하기

## 4.3 작성 및 셀프 피드백

> 함께 자라기, 역량에 맞는 글을 작성하고 있나요?

- **한 번에 작성하지 않고 점진적으로 작성해도 괜찮다.**
- 구조-핵심 내용 채우기-세부 내용 채우기
- **제한 시간 내에 초안 작성(타임 어택)**
  - 초안, 1~2시간 내외 작성하기
  - 빠르게 작성할 수 있는 부분부터 작성
- **내용 보강하기**
  - 내용을 보강하며 글 수정하기
  - 너무 확장되면 멈추고 핵심 문장 기반으로 작성하기
  - 소요 시간을 측정하고 '과거의 나'와 비교한다.
- **셀프 피드백**
